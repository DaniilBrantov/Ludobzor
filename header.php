...
<head>
    ...
    <meta name="keywords" content="Обзор онлайн казино">
    <meta name="description"
        content="Обзор лучших лицензионных онлайн казино на реальные деньги, которые платят выигрыши без задержек и комиссий. ✔️ В базе уже более 400 наименований и она наполняться новыми данными.">
    <link rel="canonical" href="https://ludobzor.com/">
    <title>Рейтинг онлайн казино — обзор ТОП лучших казино на реальные деньги с выводом</title>
...
<body>
<?php
// Define paths for images and links
            ...
            <div class="col-md-12 fullheader">
                ...
                <nav>
                    <ul itemscope itemtype="<?= $ulItemtype; ?>" class="nav navbar-nav">
                        ...
                        <li class="selectedd"><a href="javascript:;"> Провайдеры <span class="indicator"><i class="fa fa-angle-down"></i></span></a>
                            <ul class="dropdown">
